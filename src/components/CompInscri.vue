    ...
    <form @submit="onSubmit">
      ...
      <div v-if="form.status != ''" class="formInscri">
        ...
        <div class="form-group" v-if="form.status === 'association'">
          <label for="name">Association Name :
            <span class="requis">*</span>
          </label>
          <input
            id="name"
        ...
        <div class="form-group">
          ...
          <div class="input-group mb-3">
            ...
            <div class="input-group-append">
              <a class="eye" @click="type === 'text' ? type = 'password' : type = 'text'">
                <!--Ternary function-->
        ...
        <div class="form-group">
          <label for="checkPassword">Confirm Password :
            <span class="requis">*</span>
          </label>
          <div class="input-group mb-3">
            <input
        ...
        <div class="form-group">
          ...
          <div class="input-group mb-3">
            ...
            <input
              ...
              required
              placeholder="Enter ton 06"
              pattern="[0-9]{10}"
              aria-describedby="phoneHelp"
            >
          </div>
          <small id="phoneHelp" class="form-text text-muted">ex: 0612345678</small>
        </div>
        ...
        <div v-if="form.status === 'association'">
          <div v-if="form.city != null" class="bouton">
            <button class="btn btn-primary btn-lg rounded" name="submit" value="Submit"
